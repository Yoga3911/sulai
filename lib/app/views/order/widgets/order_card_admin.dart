...
class OrderCardAdmin extends StatelessWidget {
  const OrderCardAdmin({Key? key, required this.orderModel}) : super(key: key);
                        ...
                        Row(
                          children: [
                            FutureBuilder<QuerySnapshot>(
                              future: MyCollection.process
                                  .where("id", isEqualTo: orderModel.processId)
                                  .get(),
                              builder: (_, snapshot) {
                                ...
                                return Container(
                                  ...
                                  child: Text(
                                    snapshot.data!.docs.first["process"],
